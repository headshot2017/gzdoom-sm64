...
// SM64 additions
#define SM64_SHA1 "9bef1128717f958171a4afac3ed78ee2bb4e86ce"
#include "d_mario.h"
extern "C" {
        #include <sha1/sha1.h>
        #include <libsm64.h>
...
static void D_SM64Debug(const char *str)
{
        Printf("libsm64: %s\n", str);
}
...
void D_DoomMain (void)
{
	...
	do
	{
		...
		if (!restart)
		{
			...
			V_Init2();
			MarioGlobal::initThings();
			Printf("libsm64: Mario shader loaded\n");
			gl_PatchMenu();
